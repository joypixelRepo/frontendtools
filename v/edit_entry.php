			                    ...
			                    <span class="lever switch-col-amber"></span>
									...
									<div class="row">
										<div class="col-12">
											<div class="form-group">
												<div class="form-line">
													<h6>Título</h6>
													<input type="text" class="form-control" name="title" maxlength="255" autocomplete="off" value="<?= $entry[0]['title'] ?>">
												</div>
											</div>
										</div>
									</div>
										...
										<div class="col-12">
											<div class="form-group mb-2">
												<div class="form-line">
													...
													<textarea name="description" rows="1" class="textarea-code form-control no-resize auto-growth" autocomplete="off"><?= $entry[0]['description'] ?></textarea>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-12 mt-5">
											<!-- CKEditor -->
											<h6>Explicación</h6>
											<textarea id="ckeditor" name="explanation" required><?= $entry[0]['explanation'] ?></textarea>
											<!-- #END# CKEditor -->
										</div>
									</div>
