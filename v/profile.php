                ...
                <div class="card">
                    <div class="body">
                        <h2>Acceso denegado</h2>
                            <h4>No sabemos quién eres.</h4>
                            <p>Para editar tu perfil debes <a href="/<?= $_SERVER['VIEWS'] ?>/sign_in">iniciar sesión</a> en tu cuenta de usuario, o <a href="/<?= $_SERVER['VIEWS'] ?>/sign_up">registrarte</a> como nuevo usuario.</p>
                    </div>
                </div>
            </div>
        </div>
